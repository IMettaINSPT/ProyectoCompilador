...
public class Errores {
    ...
    public enum erroresEnum {
        ...
        FALTA_ASIGNACION, DESCONOCIDO, FALTA_END, FALTA_SIGNO,IDENTIFICADOR_DUPLICADO, IDENTIFICADOR_NOIDENTIFICADO, TIPO_IDENT_ERROR,GENERICO,
        FALTA_FACTOR_IDENT_PARA,  FALTA_CADENA_FACTOR_IDENT_PARA, FALTA_CONST, FALTA_TIMES, FALTA_PROCEDURE, FALTA_TO, FALTA_VAR, FALTA_EOF, FALTA_PTO, FALTA_IDENT_NUMERO
    }

    public static void mostrarErrorTipo(String token, String tipoEsperado, String tipoRecibido, String archivoSalida) {
    ...
    public static void mostrarError(erroresEnum error, Token tokenRecibido, String archivoSalida) {
        ...
        switch (error) {
            ...
            case FALTA_CONST -> {
                err = "Error :se esperaba una constante";
                System.out.println(err);
                escribirErrorLog(err, tokenRecibido, archivoSalida);
            }
            case FALTA_PROCEDURE -> {
                err = "Error :se esperaba un Procedure";
                System.out.println(err);
                escribirErrorLog(err, tokenRecibido, archivoSalida);
            }
            ...
            case FALTA_TIMES -> {
                err = "Error :se esperaba la palabra TIMES";
                System.out.println(err);
                escribirErrorLog(err, tokenRecibido, archivoSalida);
            }
            ...
            default -> {
                System.out.println("ERROR, codigo incorecto, coso roto o algo, linea: " + tokenRecibido.getValor());
                escribirErrorLog("ERROR, codigo incorecto, coso roto o algo, linea: " + tokenRecibido.getValor(), tokenRecibido, archivoSalida);
